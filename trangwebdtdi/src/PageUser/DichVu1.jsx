<div>
<meta charSet="utf-8" />
<title>Công ty cổ phần công nghệ và giải pháp AT</title>
{/* Stylesheets */}
...
<link href="css/boxchat.css" rel="stylesheet" />
{/* REVOLUTION NAVIGATION STYLES */}
<link href="css/style.css" rel="stylesheet" />
<link href="css//reponsive.css" rel="stylesheet" />
<link rel="shortcut icon" href="./css/images/iconAT.png" type="image/x-icon" />
<link rel="icon" href="./css/images/iconAT.png" type="image/x-icon" />
{/* Responsive */}
...
<div className="page-wrapper">
  ...
  <section id="home" className="features-section">
    <div className="auto-container">
        ...
        <div className="content-column col-xl-6 col-lg-7 col-md-12 col-sm-12 order-2 wow fadeInRight" data-wow-delay="600ms">
          <div className="inner-column">
            <div className="sec-title">
              ...
              {/* <div class="text">&nbsp;Chúng tôi là một công ty có trụ sở tại Việt Nam,
          chuyên phát triển và cung cấp dịch vụ lưu trữ. chúng tôi bắt đầu vào năm 2021 bởi
          một đội ngũ chuyên gia CNTT có niềm đam mê lớn đối với công nghệ, công ty chúng tôi
          đã cung cấp các chuyên gia có trình độ chuyên môn hàng đầu cho các dự án phát triển
          ở bất kỳ mức độ phức tạp nào.
          </br>&nbsp;Chúng tôi tự hào về chất lượng công việc của mình và không
          ngừng tìm kiếm những cách thức mới để cải thiện bí quyết & năng lực của mình.
        </div> */}
              <div className="text">
      ...
      <div class="info-box col-lg-6 col-md-6">
        <div class="inner">
          <i class="icon flaticon-development"></i>
          <h6 class="title">Businesses <br>Growth</h6>
        </div>
      </div>

      <div class="info-box col-lg-6 col-md-6">
        <div class="inner">
          <i class="icon flaticon-social-media"></i>
          <h6 class="title">Marketing <br>Solution</h6>
        </div>
      </div>
    </div> */}
      ...
      <li><i class="fa fa-check-circle"></i> Velit esse cillum dolore eu fugiat nulla pariatur.</li>
        ...
        <div className="image-column col-xl-6 col-lg-5 col-md-12 col-sm-12">
          <div className="inner-column wow fadeInLeft">
            ...
            {/* <figure class="image-2 overlay-anim wow fadeInRight"><img src="https://via.placeholder.com/404x279" alt=""></figure> */}
  ...
  {/*Emd About Section */}
  {/* Fun Fact Section */}
  {/* <section id="home" class="fun-fact-section pt-0">
<!-- Call To Action */}
